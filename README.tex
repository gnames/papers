...
\VariableTok{path}\OperatorTok{=}\VariableTok{$(}\FunctionTok{dirname} \VariableTok{$\{1\})}
\VariableTok{file}\OperatorTok{=}\VariableTok{$(}\FunctionTok{basename} \VariableTok{$\{1\}} \StringTok{".md"}\VariableTok{)}
\BuiltInTok{cd} \VariableTok{$\{path\}}
\ExtensionTok{pandoc} \AttributeTok{{-}C} \AttributeTok{{-}s} \StringTok{"}\VariableTok{$\{file\}}\StringTok{.md"} \AttributeTok{{-}{-}pdf{-}engine}\OperatorTok{=}\NormalTok{xelatex }\AttributeTok{{-}{-}highlight{-}style} \DataTypeTok{\textbackslash{}}
\NormalTok{  zenburn }\AttributeTok{{-}o} \StringTok{"}\VariableTok{$\{file\}}\StringTok{.pdf"}
\ExtensionTok{pandoc} \AttributeTok{{-}C} \AttributeTok{{-}s} \StringTok{"}\VariableTok{$\{file\}}\StringTok{.md"} \AttributeTok{{-}o} \StringTok{"}\VariableTok{$\{file\}}\StringTok{.tex"}
